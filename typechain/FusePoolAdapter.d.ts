...
export interface FusePoolAdapterContract
  extends Truffle.Contract<FusePoolAdapterInstance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<FusePoolAdapterInstance>;
}
