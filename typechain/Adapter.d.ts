...
export interface AdapterContract extends Truffle.Contract<AdapterInstance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<AdapterInstance>;
}
...
export interface AdapterInstance extends Truffle.ContractInstance {
  add_approved_admin: {
