...
export interface EthPoolAdapterContract
  extends Truffle.Contract<EthPoolAdapterInstance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<EthPoolAdapterInstance>;
}
...
export interface EthPoolAdapterInstance extends Truffle.ContractInstance {
  addApprovedAdmin: {
