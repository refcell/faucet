# Solidity Auditing Checklist from CryptoFin

### Core Checks

These are basic checks to undertake with any contract. Our checklist reflects Solidity v0.4.24.

- [x] Prevent overflow and underflow
  - [x] Use [SafeMath](https://github.com/OpenZeppelin/openzeppelin-solidity/blob/master/contracts/math/SafeMath.sol)
- [ ] Function Visibility
